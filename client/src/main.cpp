...
int main(int argc, char *argv[]) {
    ...
    /* bookRep.addBook(1, "The Beatles", "Paul Shipton",
                     "/home/tatyana/Programming/Проект Весна
       2022/English_Reader/client/src/books/Beatles.txt");*/
    ...
    while (true) {
        try {
            ...
            // Note 1: Though all windows had connectingWindow as parent first,
            // they now have StackedWidget as parent and so don't appear all at
            // the same time.

            // Note 2: Windows have member 'parent', but it isn't true Qt
            // parent, it's connectionWindow.

            // Note 3: We can change parent of widget, as they all inherit
            // QWidget, and it's parent is QWidget
